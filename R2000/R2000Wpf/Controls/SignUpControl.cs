...
///
///     <MyNamespace:SignUpControl/>
///
/// </summary>
public class SignUpControl : Control
{
    static SignUpControl()
    {
        DefaultStyleKeyProperty.OverrideMetadata(typeof(SignUpControl), new FrameworkPropertyMetadata(typeof(SignUpControl)));
    }
}
